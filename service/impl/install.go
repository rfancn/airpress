...
如果你看到了这一篇文章，那么证明你已经安装成功了，感谢使用 [AirPress](https://github.com/rfancn/airpress) 进行创作，希望能够使用愉快。

## 相关链接

- 开源地址：[https://github.com/rfancn/airpress](https://github.com/rfancn/airpress)
...
`
	formatContent := `<h2 id="hello-airpress" tabindex="-1">Hello AirPress</h2>
	<p>如果你看到了这一篇文章，那么证明你已经安装成功了，感谢使用 <a href="https://github.com/rfancn/airpress" target="_blank">AirPress</a> 进行创作，希望能够使用愉快。</p>
	<h2 id="%E7%9B%B8%E5%85%B3%E9%93%BE%E6%8E%A5" tabindex="-1">相关链接</h2>
	<ul>
	<li>开源地址：<a href="https://github.com/rfancn/airpress" target="_blank">https://github.com/rfancn/airpress</a></li>
...
func (i installServiceImpl) createDefaultComment(ctx context.Context, post *entity.Post) (*entity.Comment, error) {
	...
	content := "欢迎使用 AirPress，这是你的第一条评论，头像来自 [Gravatar](https://cn.gravatar.com)，" +
		"你也可以通过注册 [Gravatar]" +
	...
	comment := &entity.Comment{
		...
		Author:            "AirPress",
		AuthorURL:         "https://github.com/rfancn/airpress",
		Content:           content,
